...
const skincareProducts: Product[] = [
  ...
  },
  {
    ...
    price: 38,
    description: "The overnight beauty balm — to freshen, restore, and golden the skin while you sleep. A luxury botanical balm in a lovely glass jar, slow-melting, deeply nourishing. End of day. Lamplight. The jar on the bedside table.",
    icon: Moon,
    highlight: true,
    isHero: true,
